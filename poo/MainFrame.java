...
public class MainFrame extends JFrame { 
    ...
    private void criarMenuBar() {
        ...
        btnTema = new JButton("Modo Escuro");
    ...
    private void aplicarTema() {
        ...
        // aplica recursivamente a todos os componentes da janela
        Tema.aplicar(getContentPane(), modoEscuro);
 
        // ajusta o gráfico e o destaque de outliers, que têm cores próprias
        graficoPanel.setModoEscuro(modoEscuro);
        controller.getRenderer().setModoEscuro(modoEscuro);
 
        btnTema.setText(modoEscuro ? "Modo Claro" : "Modo Escuro");
 
        medicoesPanel.getTabela().repaint();
