...
public class FiltrosPanel extends JPanel {
    ...
    private JCheckBox chkFiltrarData;
    ...
    public FiltrosPanel() {
        ...
        chkFiltrarData = new JCheckBox("Filtrar por data");
 
        spInicio = new JSpinner(new SpinnerDateModel());
        spFim = new JSpinner(new SpinnerDateModel());
 
        spInicio.setEnabled(false);
        spFim.setEnabled(false);
 
        chkFiltrarData.addActionListener(e -> {
            boolean ativo = chkFiltrarData.isSelected();
            spInicio.setEnabled(ativo);
            spFim.setEnabled(ativo);
        });
    ...
    public void limpar() {
        ...
        chkFiltrarData.setSelected(false);
        spInicio.setEnabled(false);
        spFim.setEnabled(false);
